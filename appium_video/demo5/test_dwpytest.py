...
class TestDW():
    ...
    def test_search(self):
        ...
        5. 获取这只上 阿里巴巴的股价，并判断 这只股价的价格>200
        """
    ...
    def test_attr(self):
        ...
        if search_enabled == True:
            ...
            alibaba_elemenet = self.driver.find_element_by_xpath("//*[@resource-id='com.xueqiu.android:id/name' and @text='阿里巴巴']")
            # alibaba_elemenet.is_displayed()
            element_display = alibaba_elemenet.get_attribute("displayed")
